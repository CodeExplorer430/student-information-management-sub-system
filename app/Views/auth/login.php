...
<section class="login-layout">
    <div class="login-brand">
        <div class="login-kicker">Student Information Management</div>
        <h1>Secure access portal</h1>
        <p>Access the operations and self-service platform for student records, requests, academic visibility, lifecycle tracking, and ID issuance.</p>
    ...
    <div class="login-form-panel">
        ...
        <form method="post" action="/login" class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="email" name="email" class="form-control form-control-lg" required autocomplete="username" placeholder="name@bcp.edu">
            </div>
            <div class="col-12">
