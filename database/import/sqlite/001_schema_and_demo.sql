-- Bestlink SIS SQLite import snapshot.
-- Generated from database/migrations/sqlite/*.sql and database/seeds/sqlite/*.sql.
-- Intended for local/test inspection only; MySQL/MariaDB remains the supported runtime.
-- Demo login password for seeded users: Password123! Rotate credentials before shared deployment.

PRAGMA foreign_keys = ON;


-- Source: database/migrations/sqlite/001_create_schema.sql
...
-- Source: database/migrations/sqlite/002_multi_role_rbac.sql
...
-- Source: database/migrations/sqlite/003_workflow_notifications.sql
...
-- Source: database/migrations/sqlite/004_own_scope_permissions.sql
...
-- Source: database/seeds/sqlite/001_demo_data.sql
...
-- Source: database/seeds/sqlite/002_workflow_notifications.sql
